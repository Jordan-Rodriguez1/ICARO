	    ...
	    <div class="container-xl">			    
          ...
          <div class="row g-4 settings-section">
	          <div class="col-12 col-md-4">
	            <h3 class="section-title">Editar Despacho</h3>
                ...
                <?php if (isset($_GET['msg'])) {
                    ...
                    <?php } else if ($alert == "error") { ?>
                        <div class="alert alert-danger" role="alert">
	                        ...
	                        <div class="section-intro">No se pudo actualizar el Despacho, intente de nuevo o cantacte a soporte.</div>
                        </div>
	          ...
	          <div class="col-12 col-md-8">
	            <div class="app-card app-card-settings shadow-sm p-4">
                  ...
                  <form id="formulario1" method="POST" action="<?php echo base_url(); ?>Despachos/actualizar" autocomplete="off" enctype="multipart/form-data">
                    <div class="mb-3">
                      ...
                      <select class="form-control" id="unidad" name="unidad">
                        ...
                        <option  value="<?=$unidades['id'];?>" <?php if($data2['unidad'] == $unidades['id']){?>selected<?php }?>><?=$unidades['abreviacion']." - ".$unidades['nombre'];?></option>
                        <?php }?>
                      </select>                      
                    </div>
                    ...
                    <label class="form-label" style="color:#000000;">¿Contiene Negadas?</label>
                        ...
                        <label class="form-check-label" style="padding: 0 40px 0 0;">NO</label>
										    <input class="form-check-input" type="checkbox" id="negadas" name="negadas" <?php if($data2['negadas'] == 1){?>checked<?php }?>>
                  ...
                  <div class="mb-3">
                      ...
                      <input type="text"  class="form-control" id="remision" name="remision" value="<?= $data2['remision']; ?>" required>
                  </div>
                  <div class="mb-3">
                      <label for="eco" class="form-label" style="color:#000000;">ECO</label>
                      <input type="text"  class="form-control" id="eco" name="eco" value="<?= $data2['eco']; ?>" required>
                  </div>

                  <div class="mb-3">
                   <label for="date" class="form-label" style="color:#000000;">Fecha de Entrega</label>
                   <input type="datetime-local" min="<?php echo date('Y-m-d'); ?>" class="form-control" id="entrega" name="entrega" value="<?= $data2['fecha_entrega']; ?>" required>
                  </div>          
                </div>                        
                  <button type="submit" class="btn app-btn-primary mb-2">Editar Despacho</button>
                  <a class="btn btn-danger mb-2" href="<?php echo base_url(); ?>Despachos/Listar">Regresar</a>
                </form>
					    </div><!--//app-card-body-->
					  </div><!--//app-card-->
	        </div>
