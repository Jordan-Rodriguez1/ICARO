		    ...
		    <div class="container-xl">			    
                ...
                <div class="row g-4 settings-section">
                    ...
                    <div class="col-12 col-md-8">
						...
						<div class="app-card app-card-settings shadow-sm p-4">
						    <div class="app-card-body">
							    <form class="settings-form" action="<?php echo base_url() ?>Inicio/AgregarRegimen" method="post">
								    <div class="mb-3">
									    <label for="tipocontrata" class="form-label">Régimen
                                            <span class="ml-2" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Ingresa los tipos de régimen">
                                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-info-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                                    <path d="M8.93 6.588l-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588z"/>
                                                    <circle cx="8" cy="4.5" r="1"/>
                                        ...
                                        <div class="input-group mb-3">
                                          <input type="text" class="form-control" id="tipore" name="tipore" placeholder="Tipos de Régimen" required">
                                          <button class="btn app-btn-primary" type="submit" id="button-addon2">Agregar</button>
                                        </div>
									</div>
							    </form>
                            ...
                            <div class="app-card-footer">
                                ...
                                <?php foreach ($data7 as $regimen) { ?>
                                        <form action="<?php echo base_url() ?>Inicio/EliminarRegimen?id=<?php echo $regimen['id']; ?>" method="post" class="d-inline elim">
                                            <button title="Eliminar" type="submit" class="btn app-btn-primary mb-2"><?php echo $regimen['regimen']?> <i class="fas fa-trash"></i></button>
                                        </form>
                                <?php } ?>
                            </div><!--//app-card-body--> 
						</div><!--//app-card-->
                ...
                <div class="row g-4 settings-section">
	                ...
	                <div class="col-12 col-md-4">
		                ...
		                <div class="section-intro">Ingrese los colores por defecto de las gráficas</div>
	                </div>
                    <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
						    <div class="app-card-body">
