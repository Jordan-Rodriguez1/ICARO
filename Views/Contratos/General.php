      ...
      <div class="container-xl">
            ...
            <div class="row g-3 align-items-center">
              ...
              <div class="col-7 col-lg-auto col-md-auto text-center text-lg-center">
                <?php if (isset($_GET['msg'])) {
                    ...
                    <?php } else if ($alert == "devengo") { ?>
                        <div class="alert alert-success" role="alert">
	                        <h3 class="notification-title">DEVENGO</h3>
	                        <div class="notification-subtitle">Los datos de Devengo fueron actualizados.</div>
                        </div>
                    <?php }
                } ?>
              </div><!--//col-->
        ...
        <div class="position-relative mb-3">
            <div class="row g-3 justify-content-between">
              ...
              <div class="app-card app-card-settings shadow-sm p-4 pb-1">
						    <div class="app-card-body">
							        <form id="formulario1" class="settings-form" action="<?php echo base_url() ?>Contratos/ActualizaeDevengo" method="post">
                              ...
                              <br><span style="font-size:12px;"class="text-muted">*Actualizado al <?= $data7['fecha']?></span>
                          </label>
          ...
          <a class="flex-sm-fill text-sm-center nav-link"  id="orders-form-tab" data-toggle="tab" href="#orders-form" role="tab" aria-controls="orders-form" aria-selected="false">Formalizados</a>
                          ...
                          <tr>
                            <td>
                              <?php if ($us['estado'] == 2) { ?>
                                ...
                                <form action="<?php echo base_url() ?>Contratos/noformalizar?contrato=<?php echo $us['numero']; ?>" method="post" class="d-inline noforma">
                                  <button title="No Formalizar" type="submit" class="btn">
                                  <svg width="0.95em" height="0.95em" viewBox="0 0 512 512" fill="blue" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <td>
                              <span class="ml-2" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="No. Cuenta: <?php foreach ($data8 as $c) {if ($c['numero'] == $us['numero']) {echo $c['cuenta'];}} ?>">
                                <span><?php if ($_SESSION['rol'] == 7) { echo "<a style='color: black; text-decoration: none;' href='".base_url()."Contratos/Editar?contrato=".$us['numero']."'>".$us['numero']."</a>"; } else {echo $us['numero']; }?></span>
                              </span>
                            </td>
                            <td><?php echo substr($us['descripcion'],0,50); ?></td>
                            <td><?php echo $us['nombre']; ?></td>
                            <td>
                              <?php $termino = $us['termino'];

                                // Convertir la fecha almacenada en un objeto DateTime
                                ...
                                if ($fechaActual > $fechaTermino) {
                                    echo "<span class='text-warning'>Fenecido</span>";
                                } else {
                                    echo "<span class='text-primary'>Vigente</span>";
                                }?>
                            </td>
                            <td><?php echo '$'.number_format($us['maximo']); ?></td>
                            <td>$<?php echo number_format($us['devengo']);?></td>
                            <?php if ($us['estado'] != 1 && $us['estado'] != 5 && $us['administrador'] !=0) { ?>
		      ...
		      <div class="tab-pane fade show" id="orders-vali" role="tabpanel" aria-labelledby="orders-vali-tab">
                  ...
                  <table class="table app-table-hover mb-0 text-left" id="Table4">
                    ...
                    <tbody>
                      <?php foreach ($data1 as $us) { ?>
                        <?php if (($us['estado'] == 3 || $us['estado'] == 6) && ($_SESSION['rol'] == 7 || $_SESSION['rol'] == 5 || $_SESSION['rol'] == $us['administrador'])) { ?>
                          <tr>                            
                            <td>
                              <?php if ($us['estado'] == 2) { ?>
                                <svg width="0.95em" height="0.95em" viewBox="0 0 512 512" fill="blue" xmlns="http://www.w3.org/2000/svg">
