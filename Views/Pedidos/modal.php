  ...
  <div id="VentanaModalP" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form method="post" action="<?php echo base_url(); ?>Pedidos/Pagado" autocomplete="off" enctype="multipart/form-data">
          ...
          <input style="display:none;" type="text" class="form-control" name="id" id="id"  value="" readonly/>   
            <div class="form-group">
              <label for="setting-input-3" class="form-label" style="color:#000000;">No.Contrato y clave</label>              
              <input type="text" class="form-control" name="contrato" id="contrato"  value="" readonly/>                                                        
            </div>
